...
import { getShopData, } from "./shop/shopData.js";
import { generateCommercialOfferPdf } from "./commercialOffers/generateCommercialOfferPdf.js";
...
app.use("/files", express.static(SHOP_ROOT_DIR, {
    extensions: [],
}));
// Health
...
function requireNonEmpty(v, fieldName) {
    if (typeof v !== "string" || v.trim().length === 0) {
        throw new Error(`Invalid field "${fieldName}"`);
    }
    return v.trim();
}
function safeParseId(id, fieldName) {
